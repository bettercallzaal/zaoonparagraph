...
<!-- SUBTITLE (Paragraph field, not body):
     How Saturday runs at ZAOstock: music from noon, 8 acts back to back, the street clears at 6, then the after-party next door. -->

<!-- Send: Thu 1 Oct 2026, Zaal's tap. Voice: announcement. Zero Paragraph credits.
     Day number: 2026-10-01 = day 274.
     Sources, HTTP 200 by curl on 2026-09-19 08:5x EDT: zaostock.com/program (doors, music at
     noon, the five-minute welcome, 8 acts back to back, the MC between sets, music ends, the
     street clears at six, the after-party wording, "one venue at a time", "times can shift by a
     few minutes", Black Moon open through the day), /live (the stream on that page for the full
     window).
     NO SET TIMES. Only noon, 6 and the order.
