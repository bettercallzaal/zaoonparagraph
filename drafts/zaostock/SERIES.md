...
| Mon 21 Sep | 264 | poidh bounty one: what came in | `2026-09-21-day-264-submissions-review.md` | poidh.xyz/base/bounty/1409 | SHIPS TODAY, after the 5 pm stream. Zaal 2026-09-21: the edition reviews the submissions rather than announcing the bounty. FILL slots wait on the poidhz lane's claim list |
| Mon 21 Sep | 264 | poidh bounty one: announcement | `2026-09-21-day-264-poidhz.md` | poidh.xyz/base/bounty/1409 | SUPERSEDED same day by the review above. Kept as the record of what was drafted |
| Mon 21 Sep | 264 | Artist slot: Michael Anderson | `2026-09-21-day-264-michael-anderson.md` | zaostock.com/artist/michael-anderson | drafted, not shipping today; the poidh review took the slot. Needs a new day from Zaal |
| Tue 22 Sep | 265 | poidh bounty two: what came in | `2026-09-22-day-265-submissions-review.md` | bounty two does not exist yet | drafted as a shape only. Every bounty-two fact is unmeasured until the poidhz lane sends it |
| Tue 22 Sep | 265 | Artist slot: The Crown Vics | `2026-09-22-day-265-the-crown-vics.md` | zaostock.com/artist/the-crown-vics | DISPLACED by the poidh review above. Text ready; bio live, no photo on the page 2026-09-19, so the photo line is out. Re-fetch on the morning it moves to. ZAAL: which day? |
...
| Thu 24 Sep | 267 | 9 days out, everything you need to know | `2026-09-24-day-267-nine-days-out.md` | zaostock.com, /program, /ellsworth, /tickets | READY. Asked for by Zaal 2026-09-24: "make the best thing to share 9 days til ZaoStock things you need to know". No stream, no rain plan beyond the poster's words, nobody named as running the day |
| Thu 24 Sep | 267 | OPEN X, with a bounty block | `2026-09-24-day-267-open-x.md` | zaostock.com/artist/open-x | DISPLACED by the piece above. Third artist edition with no day, after Michael Anderson and The Crown Vics. ZAAL: which days? |
