...
<!-- SUBTITLE (Paragraph field, not body):
     3 ways to be at ZAOstock on Saturday: on Franklin Street, on zaostock.com/live, or in a space host's room. -->

<!-- Send: Wed 30 Sep 2026, Zaal's tap. Voice: announcement. Zero Paragraph credits.
     Day number: 2026-09-30 = day 273.
     Sources, HTTP 200 by curl on 2026-09-19 08:5x EDT: zaostock.com/live ("This page is where
     the stream plays", the full window, no sign-up, no account or app, space hosts play the
     stream in their own rooms and point listeners back), /tickets (no gate, no ticket checked,
     the RSVP is for planning), /ellsworth (parking).
     THE STREAM PLATFORM IS NOT NAMED, by the brief: never in public copy until a test passes.
     On 09-19 /live read "Stream not live yet. The player goes here once the watch link is
     confirmed." RE-FETCH /live ON THE MORNING OF 09-30. If the page still says that, the body
...
The 2nd way is the stream. It plays at [zaostock.com/live](https://zaostock.com/live) for the full window, 12 to 6 Eastern. No sign-up, no account, no app. Bookmark the page now and open it on Saturday.

The 3rd way is through a space host. ZAO audio-space hosts are playing the stream in their own rooms on the day and pointing their listeners back to the live page. If you already spend your Saturdays in one of those rooms, you will hear Ellsworth in it.
