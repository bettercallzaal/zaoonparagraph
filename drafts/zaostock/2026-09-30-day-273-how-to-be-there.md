...
<!-- Send: Wed 30 Sep 2026, Zaal's tap. Voice: announcement. Zero Paragraph credits.
     ...
     CHANGED 2026-09-19 14:26 EDT: /live was rewritten today. "Through a space host" became "At a
     watch party" and "Host one yourself", and the page now says "Four ways in" (it counts hosting
     as its own way; the body keeps 3 and folds hosting into the 3rd). It also added: if the picture
     stops on the day, go to the Telegram chat at telegram.thezao.com. Body updated to match.
